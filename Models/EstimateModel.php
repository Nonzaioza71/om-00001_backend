<?php
    ...
    class EstimateModel extends BaseModel
    {
        ...
        public function getAVGEstimateBy() {
            $sql = "SELECT *, AVG(COALESCE(tb_estimate_score.estimate_score, 0)) AS score
            FROM tb_estimate_list
            LEFT JOIN tb_estimate_score ON tb_estimate_score.id = tb_estimate_list.id
